...
summary_and_breefing_agent = agents.summary_and_briefing_agent()
...
summary_and_breefing = tasks.meeting_strategy_task(
    summary_and_breefing_agent, context, objective)
...
crew = Crew(
    agents=[
        ...
        summary_and_breefing_agent

    ], tasks=[
        research,
        industry_analysis,
        meeting_strategy,
        summary_and_breefing
    ]
)
